/** A class that represents the basic properties of a buy limit order
...
public class BuyLimitOrder extends Order {
  ...
  /** a constructor that is used to set up an instance of sell limit order
    ...
    */
  public BuyLimitOrder(char stockSymbol, int numberShares, double price, 
  ...
  /** a field that stores the determines whether we buy all or none
  ...
  /** a method that returns a boolean that is true if all shares have to be bought  
    * and false if not all shares have to be bought 
  ...
  public String toString() {
    return "The Buy Limit Order is for stock " + getStockSymbol() + " , " 
  ...
  public boolean equals(Object o) {
    if (o instanceof BuyLimitOrder) {
      BuyLimitOrder m = (BuyLimitOrder)o;
